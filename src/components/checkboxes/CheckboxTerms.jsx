...
//   name = 'termsAccepted', // Nombre del campo por defecto
...
//   className = '', // Clases adicionales para el checkbox
//   labelClass = '', // Clases adicionales para el label
//   dialogClass = '', // Clases adicionales para el diálogo
//   onChange, // Función para manejar el cambio de estado
//   ...props
// }) => {
...
//       {/* Label */}
//       <span className={`text-sm text-purple-700 ${labelClass}`}>
//         {label}{' '}
//         <button
//           type="button"
...
//         className={`relative z-10 ${dialogClass}`}
//       >
...
//               {dialogTitle}
//             </DialogTitle>
//             <p className="mt-2 text-sm text-gray-600">{dialogContent}</p>
//             <div className="mt-4">
//               <button
